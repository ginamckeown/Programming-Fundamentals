...
void draw() {
  ...
  if (!start) {
    ...
    while (spikeX < width) { // While Loops
      fill(0);
      triangle(spikeX, spikeY, spikeX2, spikeY2, spikeX3, spikeY);
      spikeX = spikeX + spikeSpacing;
      spikeX2 = spikeX2 + spikeSpacing;
      spikeX3 = spikeX3 + spikeSpacing;
    }
