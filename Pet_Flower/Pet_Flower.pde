...
// Buttons
float rainX, rainY, buttonW, buttonH;
boolean rainButton;
float sunX, sunY;
boolean sunButton;
...
void setup () {
  ...
  // Create a petal and drop for the length of the array
  for (int i = 0; i < petals.length; i++) {
    petals[i] = new Petal();
  }

  clouds[0] = new Cloud(70, 100, 70, 70, .5);
  clouds[1] = new Cloud(120, 80, 100, 100, .5);
  clouds[2] = new Cloud(160, 90, 60, 60, .5);
  clouds[3] = new Cloud(280, 180, 80, 80, .5);
  clouds[4] = new Cloud(330, 160, 100, 100, .5);
  clouds[5] = new Cloud(390, 180, 80, 80, .5);
  clouds[6] = new Cloud(510, 110, 90, 90, .5);
  clouds[7] = new Cloud(550, 120, 70, 70, .5);
